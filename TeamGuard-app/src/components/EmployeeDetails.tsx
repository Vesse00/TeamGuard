      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden mb-8">
        <div className="p-8 border-b border-slate-100 flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="text-center md:text-left flex-1">
            ...
            <p className="text-lg text-slate-500 font-medium mb-4">{employee.position}</p>
            <div className="flex flex-wrap justify-center md:justify-start gap-4 text-sm text-slate-600">
              <div className="flex items-center gap-2 bg-slate-50 px-3 py-1.5 rounded-full border border-slate-200"><Mail size={14} /> {employee.email || 'Brak e-maila'}</div>
